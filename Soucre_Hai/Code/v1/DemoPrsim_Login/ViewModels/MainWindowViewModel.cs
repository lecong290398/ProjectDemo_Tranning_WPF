...
namespace DemoPrsim_Login.ViewModels
{
    public class MainWindowViewModel : BindableBase
    {
        ...
        void ExecuteDangKyCommand()
        {
            ...
            {
                if (ComfimPasswordBindProp == UserBindProp.MatKhau)
                {
                    ...
                    //{
                    //    // Query.  
                    //    string query = "INSERT into Users (HoTen, MatKhau)" +
                    //    " VALUES ('" + UserBindProp.UserName + "', '" + UserBindProp.Password + "');";
